...
//Notes about Js
//Javascript has three main pillars: scope/closures, prototypes/objects, types/coertcion
...
//There are two mayor patterns in witch we organize data in Js: Classes and Modules
...
//The class mechanism allows us to organize data together with their own behaviout
//Class inheritance
...
f=x => ({ x:x*2});
f=x => {returnx*2; };
f=async x => {vary=await doSomethingAsync(x);returny*2;};someOperation( x => x*2);
